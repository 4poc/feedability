...
There is no official release yet, feedability is still under heavy development. If you want to try the current development version, follow these installation instructions:
